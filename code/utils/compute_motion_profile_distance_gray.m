function nl_dis=compute_motion_profile_distance_gray(M,M2, nx, ny, w,w1, w2, q,q1, sigm, ndx, ndy, GauK)
...
P2 = extract_patch(M2,nx,ny,w1,w);
        ...
        for dx=-ndx:ndx 
             ...
             for dy=-ndy:ndy
              ...
              %% patch distance |pi^0_x - pi^1_x+delta|^2
                D = sum((P(selx,sely,:) - P2(selx+dx,sely+dy,:)).^2, 3); 
                Diff(i,j) = sum(sum(D));
...
fprintf('computing Motion-1d distance.....');
